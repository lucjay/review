...
@ServerEndpoint(value = "/broadcasting", configurator = ServletConfig.class, decoders = MessageDecoder.class)
public class Broadsoket {
	...
	public void onMessage(MessageVO message, Session session) throws IOException {
		...
		synchronized (clients) {
			...
			} else if (message.cmd.equals("secret")) {
